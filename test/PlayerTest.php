...
class PlayerTest extends TestCase
{
  ...
  protected $compList;
    ...
    $this->compList=array();
    $this->compList[]= new Competition(1,"Oban1",11,1,36,3,1,0); //  9+2=11p
    $this->compList[]= new Competition(2,"Oban2",6,1,34,1,0,1);  // 11+0=11p
    $this->compList[]= new Competition(3,"Oban3",11,1,36,5,1,0); //  7+2= 9p
    $this->compList[]= new Competition(4,"Oban4",6,1,34,6,0,1);  //  1+0= 1p
    $this->compList[]= new Competition(5,"Oban5",11,1,36,11,1,0);//  1+2= 3p
    $this->compList[]= new Competition(6,"Oban6",6,2,34,5,1,1);   //  6+4=10p
