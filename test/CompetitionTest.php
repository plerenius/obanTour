...
class CompetitionTest extends TestCase
{
    ...
    protected function setUp() : void
    {
        ...
        $this->c1 = new Competition(
            $this->id, $this->name, $this->numOfPlayers,
            $this->doublePointsFalse, $this->result, $this->rank,
            $this->closestFlag, $this->longestDrive
        );
        $this->c2 = new Competition(
            $this->id, $this->name, $this->numOfPlayers,
    ...
    {
        $this->assertEquals(
            (10*($this->numOfPlayers-$this->rank)/($this->numOfPlayers - 1) + 1) * 2,
            $this->c2->getRankPoints()
        );
    }
    ...
    {
        $this->assertEquals(
            10 * ($this->numOfPlayers - $this->rank)/($this->numOfPlayers - 1) + 3,
            $this->c1->getTotalPoints()
        );
    }
}